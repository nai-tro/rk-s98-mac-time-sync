...
echo "[*] Creating Applications shortcut app..."
"$DIR/Scripts/create_app.sh" "" "$BIN_DIR/rksync"
...
echo "============================================================"
echo " - App         : Sync Keyboard Time.app in Applications (Spotlight: Cmd+Space -> Sync)"
